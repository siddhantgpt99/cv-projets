...
class App:
    ...
    def main_menu(self):
        root = tk.Tk()
        root.title("Pathfinding Visualizer by Group 18")

        left = tk.Frame(root, bg="#b3b3b6", width=200, height=200)
        left.pack_propagate(False)
        tk.Label(left, text="1: Choose algorithm.", fg="black", bg="#b3b3b6", anchor="center", justify="center").pack()
